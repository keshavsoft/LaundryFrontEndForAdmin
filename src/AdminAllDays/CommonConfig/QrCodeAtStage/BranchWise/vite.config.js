...
const SrcFolder = "src/AdminAllDays/CommonConfig/QrCodeAtStage/BranchWise";

const FrontEndDistFolder = "publicDir/AdminAllDays/CommonConfig/QrCodeAtStage/BranchWise";
